...
class Instance:
    ...
    properties:
        ...
        conveyors: have orders, picking stations, bins num, picking time, speed v.
    """
    ...
    def __init__(self, w_num, l_num, bins_num, robot_num, picking_station_num, orders_num, seed=1):
        ...
        task_num = self.bins_num
        self.Dip, self.Dpi, self.IO, self.sumIO = self.generate_conveyors()

        # set params
        self.capacity = 8
        self.pick_time = 30  # 环形拣选台拣货时间
        self.min_time_gap = 100  # readyTime和dueTime的最小间隔
        ...
        # get nodes
        self.n = task_num  # 任务数(实际为料箱的数量)
        self.nodeNum = 4 * task_num + self.robotNum  # 节点数
