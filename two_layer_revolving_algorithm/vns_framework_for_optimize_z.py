...
class VNS:
    ...
    def cal_objective_and_variable(self, cur_sorting_solution):
        """ calculate the objective of the variable 
        
        Args:
            cur_sorting_solution (List[]): after optimized solution of sorting.
        
        Returns:
            obj (double): the update obj after solving by neighborhood;
        """
        obj, info = utils_new.efficient_integrated_evaluate(self.problem, self.picking_solution, cur_sorting_solution)
    ...
    def run(self):
        ...
        # get variable zop init solution.
        init_solution = self.sorting_solution
