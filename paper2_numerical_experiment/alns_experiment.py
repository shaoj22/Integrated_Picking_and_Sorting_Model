...
LastEditTime: 2024-05-10 09:56:57
FilePath: \Integrated_Picking_and_Sorting_Model\paper2_numerical_experiment\\alns_experiment.py
...
def alns_experiment_runner(instances):
    ...
    save_path = "../Integrated_Picking_and_Sorting_Model/paper2_numerical_experiment/result/alns_results_of_large_scale_instances.xls"
    alns_idx = 0
    row_idx = 0
