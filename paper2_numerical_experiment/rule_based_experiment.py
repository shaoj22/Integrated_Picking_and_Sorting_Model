...
FilePath: \Integrated_Picking_and_Sorting_Model\paper2_numerical_experiment\\rule_based_experiment.py
...
def rule_based_experiment_runner(instances):
    ...
    save_path = "../Integrated_Picking_and_Sorting_Model/paper2_numerical_experiment/result/rule_based_results_of_small_scale_instances.xls"
    rule_based_idx = 0
    row_idx = 0
