...
LastEditTime: 2024-05-08 10:57:41
FilePath: \Integrated_Picking_and_Sorting_Model\paper2_numerical_experiment\\greedy_experiment.py
...
def greedy_experiment_runner(instances):
    ...
    save_path = "../Integrated_Picking_and_Sorting_Model/paper2_numerical_experiment/result/greedy_results_of_small_scale_instances.xls"
    greedy_idx = 0
    row_idx = 0
