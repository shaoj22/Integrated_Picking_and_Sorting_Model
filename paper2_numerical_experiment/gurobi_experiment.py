...
LastEditTime: 2024-05-08 11:09:01
FilePath: \Integrated_Picking_and_Sorting_Model\paper2_numerical_experiment\gurobi_experiment.py
...
from paper2_numerical_experiment.experiment_instances import *
...
def gurobi_experiment_runner(instances):
    ...
    save_path = "../paper2_numerical_experiment/result/gurobi_large_scale_instance_results.xls"
    model_idx = 0
    row_idx = 0
    for instance in instances:
        ...
        each_model_time = []
        for i in range(1):
            gurobi_solver = IntegratedGurobiModel(instance[i], time_limit=1000, init_flag=True)
...
if __name__ == "__main__":
    ...
    models3 = gurobi_experiment_runner(large_scale_instances)
